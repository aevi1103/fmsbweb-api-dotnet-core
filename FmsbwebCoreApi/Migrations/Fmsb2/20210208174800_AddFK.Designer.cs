...
namespace FmsbwebCoreApi.Migrations.Fmsb2
{
    ...
    [Migration("20210208174800_AddFK")]
    partial class AddFK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.DowntimeOwner", b =>
                {
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.LogisticCustomerName", b =>
                {
                    b.Property<string>("LogisticCustomerNameId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("DateTime")
                        .HasColumnType("datetime2");

                    b.HasKey("LogisticCustomerNameId");

                    b.ToTable("LogisticCustomerNames");
                });
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.LogisticsInventoryCostTarget", b =>
                {
                    b.Property<int>("LogisticsInventoryCostTargetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("LogisticsInventoryCostTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("LogisticsInventoryCostTargetId");

                    b.HasIndex("LogisticsInventoryCostTypeId");

                    b.ToTable("LogisticsInventoryCostTargets");
                });

            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.LogisticsInventoryCostType", b =>
                {
                    b.Property<int>("LogisticsInventoryCostTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("LogisticsInventoryCostTypeId");

                    b.ToTable("LogisticsInventoryCostTypes");
                });

            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.LogisticsInventoryLocation", b =>
                {
                    b.Property<string>("LogisticsInventoryLocationId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("TimeStamp")
                        .HasColumnType("datetime2");

                    b.HasKey("LogisticsInventoryLocationId");

                    b.ToTable("LogisticsInventoryLocations");
                });
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.Oee", b =>
                {
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.ProjectTracker", b =>
                {
                    b.Property<int>("ProjectTrackerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.SapBOM", b =>
                {
                    b.Property<int>("SapBOMId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.TwentyFourHours", b =>
                {
                    b.Property<int?>("Hour")
                        .HasColumnName("hour")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.SAP.StockSafetyDays", b =>
                {
                    b.Property<int>("StockSafetyDaysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("StockSafetyDaysId");

                    b.ToTable("StockSafetyDays");
                });
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.CreateHxH", b =>
                {
                    b.HasOne("FmsbwebCoreApi.Entity.Fmsb2.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.Fmsb2.LogisticsInventoryCostTarget", b =>
                {
                    b.HasOne("FmsbwebCoreApi.Entity.Fmsb2.LogisticsInventoryCostType", "LogisticsInventoryCostType")
                        .WithMany()
                        .HasForeignKey("LogisticsInventoryCostTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
