...
namespace FmsbwebCoreApi.Migrations.FmsbOee
{
    ...
    [Migration("20201210201421_addDowntimeTables1")]
    partial class addDowntimeTables1
    {
            ...
            modelBuilder.Entity("FmsbwebCoreApi.Entity.FmsbOee.Line", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CycleTimeSeconds = 5m,
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 757, DateTimeKind.Local).AddTicks(2045),
                            Department = "Assembly",
                            GroupName = "A2",
                        ...
                        new
                        {
                            ...
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(1937),
                            Department = "Assembly",
                            GroupName = "A3",
                        ...
                        new
                        {
                            ...
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2112),
                            Department = "Assembly",
                            GroupName = "A4",
                            ScrapInspectionLocation = 1,
                        ...
                        new
                        {
                            ...
                            CycleTimeSeconds = 8m,
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2200),
                            Department = "Assembly",
                            GroupName = "A5",
                            ScrapInspectionLocation = 2,
                        ...
                        new
                        {
                            ...
                            CycleTimeSeconds = 8m,
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2230),
                            Department = "Assembly",
                            GroupName = "A6",
                            ScrapInspectionLocation = 1,
                        ...
                        new
                        {
                            ...
                            CycleTimeSeconds = 9m,
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2259),
                            Department = "Assembly",
                            GroupName = "A7",
                            ScrapInspectionLocation = 1,
                        ...
                        new
                        {
                            ...
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2284),
                            Department = "Assembly",
                            GroupName = "A8",
                            ScrapInspectionLocation = 1,
                        ...
                        new
                        {
                            ...
                            DateModified = new DateTime(2020, 12, 10, 15, 14, 20, 764, DateTimeKind.Local).AddTicks(2308),
                            Department = "Assembly",
                            GroupName = "A9",
                            ScrapInspectionLocation = 1,
