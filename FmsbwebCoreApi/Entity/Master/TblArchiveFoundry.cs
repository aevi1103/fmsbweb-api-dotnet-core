...
{
    [Table("tblArchiveFoundry")]
    public partial class TblArchiveFoundry
    {
        public TblArchiveFoundry()
        {
            TblArchiveFoundryDetails = new HashSet<TblArchiveFoundryDetails>();
        }
        ...
        public virtual ICollection<TblArchiveFoundryDetails> TblArchiveFoundryDetails { get; set; }
    }
}
